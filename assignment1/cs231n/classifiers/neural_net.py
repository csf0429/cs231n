...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    N, D = X.shape
    # print 'W1 shape:%d  b1 shape:%d',W1.shape,b1.shape
    # print 'W2 shape:%d  b2 shape:%d',W2.shape,b2.shape
  ...
  def train(self, X, y, X_val, y_val,
    ...
    for it in xrange(num_iters):
      ...
      #########################################################################
      sample_indicies = np.random.choice(np.arange(num_train),batch_size)
